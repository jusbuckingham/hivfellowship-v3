    ...
    <Layout>
      <article className="space-y-12">
        <header className="space-y-4">
          <h1 className="text-4xl font-bold">Curriculum Outline</h1>
        </header>

        <section className="space-y-8">
          <h2 className="text-2xl font-semibold">YEAR 1, Session 1 (6 months)</h2>
          <h3 className="text-xl font-medium">Scholarship/ Leadership Development</h3>
          <ul className="list-disc pl-6 space-y-2">
            {curriculum.year1.session1.scholarshipLeadershipDevelopment.map((item, idx) => (
              <li key={idx}>{item}</li>
            ))}
          </ul>
          <h3 className="text-xl font-medium">Clinical Training/ Care</h3>
          <ul className="list-disc pl-6 space-y-2">
            {curriculum.year1.session1.clinicalTrainingCare.map((item, idx) => (
              <li key={idx}>{item}</li>
            ))}
          </ul>
          <h3 className="text-xl font-medium">Didactics and Case Studies</h3>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="space-y-8">
          <h2 className="text-2xl font-semibold">YEAR 1, Session 2 (6 months)</h2>
          <h3 className="text-xl font-medium">Clinical Training/ Care</h3>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h3 className="text-xl font-medium">Scholarship/ Leadership</h3>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h3 className="text-xl font-medium">Journal Clubs/ Teaching</h3>
          <ul className="list-disc pl-6 space-y-2">
        ...
        <section className="space-y-8">
          <h2 className="text-2xl font-semibold">YEAR 2</h2>
          <h3 className="text-xl font-medium">Clinical Training/ Care</h3>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h3 className="text-xl font-medium">Scholarship and Research</h3>
        ...
        <section className="space-y-8">
          <h2 className="text-2xl font-semibold">Core Clinical Training Experiences</h2>

          <h3 className="text-xl font-medium">HIV Primary Care</h3>
          ...
          <h3 className="text-xl font-medium">Emergency Department HIV Consultation</h3>
          <p className="text-gray-700">
            {curriculum.coreClinicalTrainingExperiences.emergencyDepartmentHIVConsultation}
          </p>

          <h3 className="text-xl font-medium">HIV Subspecialty Care</h3>
          <p className="text-gray-700">
          ...
          <h3 className="text-xl font-medium">Inpatient Care</h3>
          <p className="text-gray-700">
        ...
        <section className="space-y-8">
          <h2 className="text-2xl font-semibold">Teaching/ Training Opportunities</h2>
          <p className="text-gray-700">
